...
public class SendSms
{
    ...
    public string sendotp(string Vmessage, string Vmobno)
    {
        ...
        //string sms_url = ("http://bulksms.itfuturz.com/api/sendmsg.php?user=magikr&pass=dns@123&sender=MAGIKR&phone=" + Vmobno + "&text=" + Vmessage + "&priority=ndnd&stype=normal");
        ...
        ////HttpWebRequest req = (HttpWebRequest)WebRequest.Create("http://bulksms.itfuturz.com/api/sendmsg.php?user=magikr&pass=dns@123&sender=MAGIKR&phone=" + Vmobno + " No&text=" + Vmessage + "&priority=Priority&stype=smstype");

        //HttpWebRequest req = (HttpWebRequest)WebRequest.Create("http://bulksms.itfuturz.com/api/sendmsg.php?user=magikr&pass=dns@123&sender=MAGIKR&phone=" + Vmobno + "&text=" + Vmessage + "&priority=ndnd&stype=normal");
    ...
    public HttpWebResponse sendotpPetPalace(string Vmessage, string Vmobno)
    {
        string outputBuffer = "where=46038";
        ...
        HttpWebRequest req = (HttpWebRequest)WebRequest.Create("https://api.whatsapp.com/send?phone=91" + Vmobno + "&text='" + Vmessage + "'");
